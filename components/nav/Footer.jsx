...
export default function Footer() {
  ...
  return (
    <div className=" py-16 dark:bg-slate-950 bg-slate-50 border-t border-slate-700 dark:border-white">
      <div className=" container grid grid-cols-1 md:grid-cols-2 gap-16">
        <div className=" flex flex-col gap-8">
          <Image
            src={Logo}
            alt="logo-pic"
            className=" xl:w-[80px] xl:h-[80px] w-14 h-14 aspect-square"
            width={80}
            height={80}
          />
          <p className=" text-slate-800 dark:text-slate-100 sm:text-xs text-xs lg:text-sm xl:text-lg">
          ...
          <p className=" uppercase text-slate-800 dark:text-slate-100 font-bold sm:text-xs text-xs lg:text-sm xl:text-lg">
            designed and developed by karim
          </p>
        </div>
        <div>
          ...
          <div className=" flex gap-4  items-center lg:mt-10 mt-10 justify-start">
